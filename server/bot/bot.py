...
responses_list = [
	...
	{"key": ["hogyvagy"], "answers": ["Jól, köszi!", "Minden oké!", "Remekül!","Koszi, minden ok", "Jol", "Turhetoen", "Minden ok, unalom"]},
	...
	{"key": ["hogytelik"], "answers": ["Jol","Eleg jol","Egesz jol","Turhetoen"]},
...
default_responses = [":)", ":P", "hmmm"] #,"Na, de meselj valamit","Es te, hogy vagy?","Te micsi?","Meselj, milyen napod volt?"
